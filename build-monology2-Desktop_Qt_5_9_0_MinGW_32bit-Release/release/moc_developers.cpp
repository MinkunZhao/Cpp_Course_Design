...
#include "../../monology2/developers.h"
...
void Developers::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Developers *_t = static_cast<Developers *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Developers::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Developers.data,
      qt_meta_data_Developers,  qt_static_metacall, nullptr, nullptr}
};
...
void *Developers::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Developers.stringdata0))
        return static_cast<void*>(const_cast< Developers*>(this));
